/**
 * ----------------------------------------------------------------------------
 * This is a MFRC522 library example; see https://github.com/miguelbalboa/rfid and https://create.arduino.cc/projecthub/Aritro/security-access-using-rfid-reader-f7c746
...
void loop() {
    ...
    if(digitalRead(7) == 1){
            ...
            // FIX LIGHTING
      ledStrip(0, 29, 0, 127.5, 0);
      ledStrip(30, 59, 127.5, 96, 101.5);
...
void ledStrip(int start, int amount, int red, int green, int blue) {
